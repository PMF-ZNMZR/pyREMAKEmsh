...
# Description:
#
# INPUT: - Geometry saved in .json file, example: GeometryData1.json
#        - Change input geometry in line 1089
#
# OUTPUT: - 2 geometry files: GeometryBeforeBooleanOperations.geo_unrolled, GeometryAfterBooleanOperations.geo_unrolled
#         - 2 mesh files: NonRecombinedMesh.msh, RecombinedFinalMesh.msh
#         - these 4 files can be opened and visualised in Gmsh(4.7.1 or newer)
#
###################################################################################################
...
input_dictionary = SaveJsonToDict('GeometryData1.json')
CreateMesh(input_dictionary, 1e-4)
